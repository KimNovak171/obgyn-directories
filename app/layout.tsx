...
export const metadata: Metadata = {
  metadataBase: new URL("https://obgyndirectories.com"),
  title: {
    default: "ObGynDirectories.com | OB-GYN & Women's Health Directory",
    template: "%s | ObGynDirectories.com",
  },
  description:
    "ObGynDirectories.com is a professional directory helping patients and families find OB-GYN practices and women's health providers across the United States and Canada.",
  alternates: {
    canonical: "/",
  },
  openGraph: {
    title: "ObGynDirectories.com | OB-GYN & Women's Health Directory",
    description:
      "Trusted resource to explore and compare OB-GYN practices and women's health providers across North America.",
    url: "/",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "ObGynDirectories.com logo preview",
      },
    ],
  },
};
  ...
  return (
    <html lang="en">
      <head>
        ...
        <script
          async
          src="https://www.googletagmanager.com/gtag/js?id=G-BDW6J7LCZH"
        />
        <script
        ...
        <div className="flex min-h-screen flex-col bg-surface text-foreground">
            ...
            <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
              <div className="flex items-center gap-6">
                <Link
                  ...
                  aria-label="ObGynDirectories.com – go to homepage"
                >
              ...
              <p className="ml-4 hidden max-w-xs text-right text-xs text-white/90 sm:block">
                Trusted OB-GYN and women's health directory for patients and families.
              </p>
            </div>
          </header>
          ...
          <footer className="w-full border-t border-teal/10 bg-surface">
            <div className="mx-auto flex max-w-6xl flex-col gap-4 px-4 py-5 text-xs text-foreground/80 sm:px-6 lg:px-8">
              <p>
                © {new Date().getFullYear()} ObGynDirectories.com. For
