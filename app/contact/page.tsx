...
export const metadata: Metadata = {
  title: "Contact Us | OB-GYN Directories",
  description:
    "Get in touch with ObGynDirectories.com. Send a message or email hello@directoriesnetwork.com for questions about our directory or featured listings.",
  alternates: {
    canonical: "/contact",
    languages: {
      "en-us": "https://obgyndirectories.com/contact",
    },
  },
  openGraph: {
    title: "Contact Us | OB-GYN Directories",
    description:
      "Contact ObGynDirectories.com for questions about our directory or featured listings.",
    url: "/contact",
...
export default function ContactPage() {
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "ObGynDirectories.com", item: `${siteUrl}/` },
