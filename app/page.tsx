      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "ObGynDirectories.com homepage preview",
        },
      ],
    },
  };
    ...
    itemListElement: [
      {
        ...
        item: "https://obgyndirectories.com/",
      },
    ],
  };
    ...
    <div className="bg-surface text-foreground">
      ...
      <section className="bg-surface">
        <div className="mx-auto flex max-w-6xl flex-col gap-10 px-4 py-12 sm:px-6 lg:py-16 lg:px-8">
          ...
          <section className="border-y-2 border-teal/30 bg-surface">
          ...
          <div className="w-full rounded-2xl border-2 border-teal/40 bg-surface p-6 shadow-xl shadow-navy/20 ring-1 ring-teal/30">
            ...
            <p className="mt-2 text-sm text-foreground/90">
              Browse verified OB-GYN and women's health practices by state, then drill down by
      ...
      {canadaDirectory.length > 0 && (
        <section className="mx-auto max-w-6xl px-4 pt-8 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-semibold text-navy">
            Canadian OB-GYN Directories
          </h2>
          <p className="mt-2 text-sm text-slate-600">
            Browse verified OB-GYN and women's health practices by Canadian province. Same
      ...
      {(() => {
        ...
        return (
          <section className="mx-auto max-w-6xl rounded-2xl border-2 border-teal/20 bg-surface px-4 py-10 sm:px-6 lg:px-8">
            <h2 className="text-xl font-semibold text-foreground">
              Featured OB-GYN practices
            </h2>
            <p className="mt-1 text-sm text-slate-600">
              Selected practices across our directories — verified listings for
              patients comparing women's health care options.
            </p>
      ...
      <p className="mx-auto max-w-2xl rounded-lg border-2 border-teal/40 bg-surface px-4 py-3 text-center text-sm text-slate-700">
        OB-GYN practice owners: Get featured at the top of your city listing.{" "}
        <Link
          href="/advertise"
        ...
        <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            ...
            <div className="rounded-xl border-l-4 border-teal border border-surface-muted bg-surface p-5 shadow-sm">
              ...
              <p className="mt-2 text-sm text-slate-600">
                Compare local options by city with ratings, women's health services,
                and contact details.
              </p>
            </div>
            <div className="rounded-xl border-l-4 border-teal border border-surface-muted bg-surface p-5 shadow-sm">
              ...
              <h3 className="mt-3 text-lg font-semibold text-foreground">
                Contact OB-GYN practices directly
              </h3>
              <p className="mt-2 text-sm text-slate-600">
        ...
        <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
          <div className="rounded-2xl border border-gold/50 bg-surface p-6 text-foreground ring-1 ring-gold/30">
            <h2 className="text-2xl font-semibold text-foreground">
              Are You an OB-GYN Practice Owner?
            </h2>
            <p className="mt-3 max-w-3xl text-sm text-foreground/90">
              Get your practice seen by patients actively searching for OB-GYN and
              women's health care options in your city. Featured listings available.
            </p>
            <div className="mt-5">
              <Link
                href="/advertise"
